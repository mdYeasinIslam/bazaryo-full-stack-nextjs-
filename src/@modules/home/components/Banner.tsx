...
const heroProducts: Product[] = [
  ...
  },
  {
    ...
    name: "Laptop Stand",
    image:
      "https://i.ibb.co.com/GQ4Mq1vQ/Gear-Branch-laptop-stand-SOURCE-Branch.jpg",
    price: "$89",
...
const Banner: React.FC<IProps> = ({ products = heroProducts }) => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="space-y-8 lg:pr-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-(--primary-color-700) text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-(--hover-color) transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center">
