...
export default function Products() {
  return (
    <div className="grid grid-cols-5 gap-5">
      <div className=" col-span-2 gird grid-cols-2 gap-5 bg-white">
        <div className=" ">
          <Image
      ...
      <div className=" col-span-3 gird grid-c ols-2gap-5 bg-white ">
      ...
      <div className=" col-span-3 gird grid-cols-2 gap-5 bg-white ">
        <div className=" w-full">
          <Image
            src={"/images/card2.png"}
            alt="card image"
